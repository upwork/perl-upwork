...
sub get_by_freelancer {
    ...
    return $self->client()->get("/finreports/v2/providers/" . $freelancer_ref . "/billings", %params);
}
...
sub get_by_buyers_team {
    ...
    return $self->client()->get("/finreports/v2/buyer_teams/" . $buyer_team_ref . "/billings", %params);
}
...
sub get_by_buyers_company {
    ...
    return $self->client()->get("/finreports/v2/buyer_companies/" . $buyer_company_ref . "/billings", %params);
}
